	...
	protected RouteBuilder createRouteBuilder() {
		...
		return new RouteBuilder() {
			...
			public void configure() {
				...
				LowerLimit lowerLimit1 = new LowerLimit("Parameter1", -5);
				UpperLimit upperLimit1 = new UpperLimit("Parameter1", 3);

				LowerLimit lowerLimit2 = new LowerLimit("Parameter2", 2);
				UpperLimit upperLimit2 = new UpperLimit("Parameter2", 10);
