...
public class MockContainerModelFactory implements IContainerFactory {
	...
	public void initialise() {
		...
		// Create the apid (ID) parameter type and add it to the packet header and containers collection.
		...
		// Create a packet type, add it to the packet body, add a restriction to associate it to an ID, and add it to the containers collection
		...
		// Create a parameter for packetTypeA and add it to the packet type and the container collection
		...
		// Create a parameter for packetTypeB and add it to the packet type and the container collection
	...
	/**
	 * Convenience method to add a container with the key set to the containers name.
	 * This is less error prone and less work assuming you want the key to be the same
