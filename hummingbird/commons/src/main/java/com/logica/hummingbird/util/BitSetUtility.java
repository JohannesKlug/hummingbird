...
public class BitSetUtility {
	...
	public static int combine(byte[] b, boolean isBigEndian, int sizeIntBits) {
		// Defensive!
		if (b.length > 4) {
		...
		// We need to chop off (right shift) the size of an int (4 Bytes) minus the required bytes.
