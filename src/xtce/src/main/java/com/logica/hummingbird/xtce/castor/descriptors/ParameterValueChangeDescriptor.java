...
import com.logica.hummingbird.xtce.castor.ParameterValueChange;
...
public class ParameterValueChangeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ParameterValueChangeDescriptor() {
        ...
        //-- _change
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.logica.hummingbird.xtce.castor.Change.class, "_change", "Change", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ParameterValueChange target = (ParameterValueChange) object;
                    target.setChange( (com.logica.hummingbird.xtce.castor.Change) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.logica.hummingbird.xtce.castor.Change();
            }
        };
        desc.setSchemaType("com.logica.hummingbird.xtce.castor.Change");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.omg.org/space/xtce");
        desc.setRequired(true);
        desc.setMultivalued(false);
    ...
    public java.lang.Class getJavaClass(
        ...
        return com.logica.hummingbird.xtce.castor.ParameterValueChange.class;
    }
