 ...
 */
public class SplineCalibratorDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SplineCalibratorDescriptor() {
        super();
        _nsURI = "http://www.omg.org/space/xtce";
        _xmlName = "SplineCalibrator";
        ...
        //-- _extrapolate
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.Boolean.TYPE, "_extrapolate", "extrapolate", org.exolab.castor.xml.NodeType.Attribute);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                SplineCalibrator target = (SplineCalibrator) object;
                if (!target.hasExtrapolate()) { return null; }
                return (target.getExtrapolate() ? java.lang.Boolean.TRUE : java.lang.Boolean.FALSE);
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    // if null, use delete method for optional primitives 
                    if (value == null) {
                        target.deleteExtrapolate();
                        return;
                    }
                    target.setExtrapolate( ((java.lang.Boolean) value).booleanValue());
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        //-- validation code for: _extrapolate
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        ...
        //-- validation code for: _splinePointList
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
