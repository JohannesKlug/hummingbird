...
public class Location extends Named {
	 ...
	 */
	public Location(String name, String description, D3Vector position) {
	 ...
	 */
	public Location(String name, String description, long timestamp, D3Vector position) {
	...
	protected double thresholdElevation = 5.;
