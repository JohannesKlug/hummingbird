...
import org.hbird.business.tasks.AbstractTask;
...
public abstract class AbstractCheck extends AbstractTask {
	 ...
	 * 
	 * @param arg0
	 *            The exchange to be send.
	 * @param stateOff
	 *            The name of the parameter that this is the state of.
	 * @param validity
	 *            The state of the state (true or false)
	 */
	@Override
