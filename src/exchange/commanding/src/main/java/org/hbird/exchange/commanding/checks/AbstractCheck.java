...
import org.hbird.exchange.commanding.AbstractTask;
...
public abstract class AbstractCheck extends AbstractTask {
	...
	public AbstractCheck(String name, String description, long deltaTime, StateParameter stateParameter) {
		super(name, description, deltaTime);
	...
	public Object execute() {
		...
		// TODO Retrieve using the request-response pattern of Camel.
