package org.hbird.exchange.commanding.actions;
...
public class ReflectiveSetParameter extends SetParameter {
	 ...
	 */
	public ReflectiveSetParameter(String name, String description, long executionTime, Parameter parameter, Argument argument) {
