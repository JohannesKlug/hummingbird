...
public class Parameter extends Named {
	 ...
	 */
	public Parameter(String name, String description, Object value, String unit) {
	 ...
	 * @param unit The unit of the value.
	 */
	public Parameter(String name, String description, long timestamp, Object value, String unit) {
