...
public class StateParameter extends Parameter {
	...
	/** The object that this state parameter is a state of. */
	protected Object isStateOff;
	 ...
	 */
	public StateParameter(String stateName, String description, Object isStateOff, boolean state) {
		super(stateName, description, state, "");
	 ...
	 * @param state The current state.
	 */
	public StateParameter(String stateName, String description, long timestamp, Object isStateOff, boolean state) {
		super(stateName, description, timestamp, state, "");
		this.isStateOff = isStateOff;
	}
	
	/**
	 * Getter of the object that this state parameter is a state off.
	 * 
	 * @return The object that this state is the state off.
	 */
	public Object getIsStateOff() {
		return isStateOff;
	}

	
	/**
	 * Setter of the object that this state is the state off.
	 * 
	 * @param isStateOff The object that this state is the state off.
	 */
	public void setIsStateOff(Object isStateOff) {
		this.isStateOff = isStateOff;
	}
