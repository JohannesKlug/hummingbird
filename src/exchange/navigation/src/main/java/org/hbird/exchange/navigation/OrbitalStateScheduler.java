...
public class OrbitalStateScheduler {
	...
	/**
	 * Constructor of an already initialised scheduler.
	 * 
	 ...
	 */
	public void createPredictionRequest(Exchange exchange) {
		synchronized(this) {
	 ...
	 */
	public void setOrbitalState(@Body OrbitalState newState) {
		synchronized(this) {
	 ...
	 */
	public void setPosition(@Body D3Vector newPosition) {
		synchronized(this) {
	 ...
	 */
	public void setVelocity(@Body D3Vector newVelocity) {
		synchronized(this) {
