...
public class NumberToStringTypeChoiceItem implements java.io.Serializable {
     ...
     */
    private org.hbird.transport.xtce.castor.ValueEnumeration _valueEnumeration;

    /**
     * A string value associated with a numerical range.
     */
    private org.hbird.transport.xtce.castor.RangeEnumeration _rangeEnumeration;
     ...
     */
    public org.hbird.transport.xtce.castor.RangeEnumeration getRangeEnumeration(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.ValueEnumeration getValueEnumeration(
    ) {
    ...
    public void setRangeEnumeration(
            final org.hbird.transport.xtce.castor.RangeEnumeration rangeEnumeration) {
    ...
    public void setValueEnumeration(
            final org.hbird.transport.xtce.castor.ValueEnumeration valueEnumeration) {
