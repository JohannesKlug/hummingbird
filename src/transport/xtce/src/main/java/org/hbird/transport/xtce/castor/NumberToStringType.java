...
public class NumberToStringType implements java.io.Serializable {
     ...
     */
    private org.hbird.transport.xtce.castor.NumberToStringTypeChoice _numberToStringTypeChoice;

    /**
     * Field _numberFormat.
     */
    private org.hbird.transport.xtce.castor.NumberFormat _numberFormat;
     ...
     */
    public org.hbird.transport.xtce.castor.NumberFormat getNumberFormat(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.NumberToStringTypeChoice getNumberToStringTypeChoice(
    ) {
    ...
    public void setNumberFormat(
            final org.hbird.transport.xtce.castor.NumberFormat numberFormat) {
    ...
    public void setNumberToStringTypeChoice(
            final org.hbird.transport.xtce.castor.NumberToStringTypeChoice numberToStringTypeChoice) {
     ...
     * org.hbird.xtce.castor.NumberToStringType
     */
    public static org.hbird.transport.xtce.castor.NumberToStringType unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.NumberToStringType) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.NumberToStringType.class, reader);
    }
