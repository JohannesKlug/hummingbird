...
public class AlarmConditionsType implements java.io.Serializable {
     ...
     * Field _watchAlarm.
     */
    private org.hbird.transport.xtce.castor.WatchAlarm _watchAlarm;

    /**
     * Field _warningAlarm.
     */
    private org.hbird.transport.xtce.castor.WarningAlarm _warningAlarm;

    /**
     * Field _distressAlarm.
     */
    private org.hbird.transport.xtce.castor.DistressAlarm _distressAlarm;

    /**
     * Field _critialAlarm.
     */
    private org.hbird.transport.xtce.castor.CritialAlarm _critialAlarm;

    /**
     * Field _severeAlarm.
     */
    private org.hbird.transport.xtce.castor.SevereAlarm _severeAlarm;
     ...
     */
    public org.hbird.transport.xtce.castor.CritialAlarm getCritialAlarm(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.DistressAlarm getDistressAlarm(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.SevereAlarm getSevereAlarm(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.WarningAlarm getWarningAlarm(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.WatchAlarm getWatchAlarm(
    ) {
    ...
    public void setCritialAlarm(
            final org.hbird.transport.xtce.castor.CritialAlarm critialAlarm) {
    ...
    public void setDistressAlarm(
            final org.hbird.transport.xtce.castor.DistressAlarm distressAlarm) {
    ...
    public void setSevereAlarm(
            final org.hbird.transport.xtce.castor.SevereAlarm severeAlarm) {
    ...
    public void setWarningAlarm(
            final org.hbird.transport.xtce.castor.WarningAlarm warningAlarm) {
    ...
    public void setWatchAlarm(
            final org.hbird.transport.xtce.castor.WatchAlarm watchAlarm) {
     ...
     */
    public static org.hbird.transport.xtce.castor.AlarmConditionsType unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.AlarmConditionsType) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.AlarmConditionsType.class, reader);
    }
