...
public class StringDataEncodingType extends org.hbird.transport.xtce.castor.DataEncodingType 
implements java.io.Serializable
{
     ...
     * Field _encoding.
     */
    private org.hbird.transport.xtce.castor.types.StringDataEncodingTypeEncodingType _encoding = org.hbird.transport.xtce.castor.types.StringDataEncodingTypeEncodingType.fromValue("UTF-8");
     ...
     * tests true
     */
    private org.hbird.transport.xtce.castor.StringDataEncodingTypeContextCalibratorList _contextCalibratorList;

    /**
     * Field _sizeInBits.
     */
    private org.hbird.transport.xtce.castor.StringDataEncodingTypeSizeInBits _sizeInBits;
    ...
    public StringDataEncodingType() {
        super();
        setEncoding(org.hbird.transport.xtce.castor.types.StringDataEncodingTypeEncodingType.fromValue("UTF-8"));
    }
     ...
     */
    public org.hbird.transport.xtce.castor.StringDataEncodingTypeContextCalibratorList getContextCalibratorList(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.types.StringDataEncodingTypeEncodingType getEncoding(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.StringDataEncodingTypeSizeInBits getSizeInBits(
    ) {
    ...
    public void setContextCalibratorList(
            final org.hbird.transport.xtce.castor.StringDataEncodingTypeContextCalibratorList contextCalibratorList) {
    ...
    public void setEncoding(
            final org.hbird.transport.xtce.castor.types.StringDataEncodingTypeEncodingType encoding) {
    ...
    public void setSizeInBits(
            final org.hbird.transport.xtce.castor.StringDataEncodingTypeSizeInBits sizeInBits) {
     ...
     */
    public static org.hbird.transport.xtce.castor.StringDataEncodingType unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.StringDataEncodingType) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.StringDataEncodingType.class, reader);
    }
