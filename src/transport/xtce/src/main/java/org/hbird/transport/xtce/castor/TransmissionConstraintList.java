...
public class TransmissionConstraintList implements java.io.Serializable {
     ...
     * condition is true.
     */
    private java.util.List<org.hbird.transport.xtce.castor.TransmissionConstraint> _transmissionConstraintList;
    ...
    public TransmissionConstraintList() {
        super();
        this._transmissionConstraintList = new java.util.ArrayList<org.hbird.transport.xtce.castor.TransmissionConstraint>();
    }
    ...
    public void addTransmissionConstraint(
            final org.hbird.transport.xtce.castor.TransmissionConstraint vTransmissionConstraint)
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.hbird.transport.xtce.castor.TransmissionConstraint> enumerateTransmissionConstraint(
    ) {
     ...
     * the given index
     */
    public org.hbird.transport.xtce.castor.TransmissionConstraint getTransmissionConstraint(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.hbird.transport.xtce.castor.TransmissionConstraint) _transmissionConstraintList.get(index);
    }
    ...
    public org.hbird.transport.xtce.castor.TransmissionConstraint[] getTransmissionConstraint(
        ...
        org.hbird.transport.xtce.castor.TransmissionConstraint[] array = new org.hbird.transport.xtce.castor.TransmissionConstraint[0];
        return (org.hbird.transport.xtce.castor.TransmissionConstraint[]) this._transmissionConstraintList.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends org.hbird.transport.xtce.castor.TransmissionConstraint> iterateTransmissionConstraint(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.TransmissionConstraint removeTransmissionConstraintAt(
            final int index) {
        java.lang.Object obj = this._transmissionConstraintList.remove(index);
        return (org.hbird.transport.xtce.castor.TransmissionConstraint) obj;
    }
     ...
     */
    public void setTransmissionConstraint(
            final org.hbird.transport.xtce.castor.TransmissionConstraint[] vTransmissionConstraintArray) {
        //-- copy array
     ...
     */
    public static org.hbird.transport.xtce.castor.TransmissionConstraintList unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.TransmissionConstraintList) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.TransmissionConstraintList.class, reader);
    }
