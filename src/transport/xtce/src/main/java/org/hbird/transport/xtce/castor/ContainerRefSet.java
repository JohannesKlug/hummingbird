...
public class ContainerRefSet implements java.io.Serializable {
     ...
     */
    private java.util.List<org.hbird.transport.xtce.castor.ContainerRef> _containerRefList;
    ...
    public ContainerRefSet() {
        super();
        this._containerRefList = new java.util.ArrayList<org.hbird.transport.xtce.castor.ContainerRef>();
    }
    ...
    public void addContainerRef(
            final org.hbird.transport.xtce.castor.ContainerRef vContainerRef)
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.hbird.transport.xtce.castor.ContainerRef> enumerateContainerRef(
    ) {
    ...
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.hbird.transport.xtce.castor.ContainerRef) _containerRefList.get(index);
    }
    ...
    public org.hbird.transport.xtce.castor.ContainerRef[] getContainerRef(
        ...
        org.hbird.transport.xtce.castor.ContainerRef[] array = new org.hbird.transport.xtce.castor.ContainerRef[0];
        return (org.hbird.transport.xtce.castor.ContainerRef[]) this._containerRefList.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends org.hbird.transport.xtce.castor.ContainerRef> iterateContainerRef(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.ContainerRef removeContainerRefAt(
            final int index) {
        java.lang.Object obj = this._containerRefList.remove(index);
        return (org.hbird.transport.xtce.castor.ContainerRef) obj;
    }
     ...
     */
    public void setContainerRef(
            final org.hbird.transport.xtce.castor.ContainerRef[] vContainerRefArray) {
        //-- copy array
     ...
     */
    public static org.hbird.transport.xtce.castor.ContainerRefSet unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.ContainerRefSet) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.ContainerRefSet.class, reader);
    }
