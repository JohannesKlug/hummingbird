...
public class TriggerType implements java.io.Serializable {
     ...
     * Field _items.
     */
    private java.util.List<org.hbird.transport.xtce.castor.TriggerTypeItem> _items;
    ...
    public TriggerType() {
        super();
        this._items = new java.util.ArrayList<org.hbird.transport.xtce.castor.TriggerTypeItem>();
    }
    ...
    public void addTriggerTypeItem(
            final org.hbird.transport.xtce.castor.TriggerTypeItem vTriggerTypeItem)
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.hbird.transport.xtce.castor.TriggerTypeItem> enumerateTriggerTypeItem(
    ) {
     ...
     * given index
     */
    public org.hbird.transport.xtce.castor.TriggerTypeItem getTriggerTypeItem(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.hbird.transport.xtce.castor.TriggerTypeItem) _items.get(index);
    }
    ...
    public org.hbird.transport.xtce.castor.TriggerTypeItem[] getTriggerTypeItem(
        ...
        org.hbird.transport.xtce.castor.TriggerTypeItem[] array = new org.hbird.transport.xtce.castor.TriggerTypeItem[0];
        return (org.hbird.transport.xtce.castor.TriggerTypeItem[]) this._items.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends org.hbird.transport.xtce.castor.TriggerTypeItem> iterateTriggerTypeItem(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.TriggerTypeItem removeTriggerTypeItemAt(
            final int index) {
        java.lang.Object obj = this._items.remove(index);
        return (org.hbird.transport.xtce.castor.TriggerTypeItem) obj;
    }
     ...
     */
    public void setTriggerTypeItem(
            final org.hbird.transport.xtce.castor.TriggerTypeItem[] vTriggerTypeItemArray) {
        //-- copy array
        _items.clear();
     ...
     */
    public static org.hbird.transport.xtce.castor.TriggerType unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.TriggerType) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.TriggerType.class, reader);
    }
