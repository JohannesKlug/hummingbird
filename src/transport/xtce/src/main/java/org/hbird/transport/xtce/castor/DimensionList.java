...
public class DimensionList implements java.io.Serializable {
     ...
     */
    private java.util.List<org.hbird.transport.xtce.castor.Dimension> _dimensionList;
    ...
    public DimensionList() {
        super();
        this._dimensionList = new java.util.ArrayList<org.hbird.transport.xtce.castor.Dimension>();
    }
    ...
    public void addDimension(
            final org.hbird.transport.xtce.castor.Dimension vDimension)
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.hbird.transport.xtce.castor.Dimension> enumerateDimension(
    ) {
     ...
     * index
     */
    public org.hbird.transport.xtce.castor.Dimension getDimension(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.hbird.transport.xtce.castor.Dimension) _dimensionList.get(index);
    }
    ...
    public org.hbird.transport.xtce.castor.Dimension[] getDimension(
        ...
        org.hbird.transport.xtce.castor.Dimension[] array = new org.hbird.transport.xtce.castor.Dimension[0];
        return (org.hbird.transport.xtce.castor.Dimension[]) this._dimensionList.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends org.hbird.transport.xtce.castor.Dimension> iterateDimension(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.Dimension removeDimensionAt(
            final int index) {
        java.lang.Object obj = this._dimensionList.remove(index);
        return (org.hbird.transport.xtce.castor.Dimension) obj;
    }
     ...
     */
    public void setDimension(
            final org.hbird.transport.xtce.castor.Dimension[] vDimensionArray) {
        //-- copy array
     ...
     */
    public static org.hbird.transport.xtce.castor.DimensionList unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.DimensionList) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.DimensionList.class, reader);
    }
