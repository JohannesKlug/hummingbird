...
public class StringDataType extends org.hbird.transport.xtce.castor.BaseDataType 
implements java.io.Serializable
{
     ...
     */
    private org.hbird.transport.xtce.castor.types.BaseDataTypeCharacterWidthType _characterWidth;

    /**
     * Field _sizeRangeInCharacters.
     */
    private org.hbird.transport.xtce.castor.SizeRangeInCharacters _sizeRangeInCharacters;
     ...
     */
    private org.hbird.transport.xtce.castor.ContextCalibratorList _contextCalibratorList;
     ...
     */
    public org.hbird.transport.xtce.castor.types.BaseDataTypeCharacterWidthType getCharacterWidth(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.ContextCalibratorList getContextCalibratorList(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.SizeRangeInCharacters getSizeRangeInCharacters(
    ) {
    ...
    public void setCharacterWidth(
            final org.hbird.transport.xtce.castor.types.BaseDataTypeCharacterWidthType characterWidth) {
    ...
    public void setContextCalibratorList(
            final org.hbird.transport.xtce.castor.ContextCalibratorList contextCalibratorList) {
    ...
    public void setSizeRangeInCharacters(
            final org.hbird.transport.xtce.castor.SizeRangeInCharacters sizeRangeInCharacters) {
     ...
     */
    public static org.hbird.transport.xtce.castor.StringDataType unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.StringDataType) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.StringDataType.class, reader);
    }
