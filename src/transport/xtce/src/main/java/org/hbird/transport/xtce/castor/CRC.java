...
public class CRC implements java.io.Serializable {
     ...
     * Field _reference.
     */
    private org.hbird.transport.xtce.castor.types.CRCReferenceType _reference = org.hbird.transport.xtce.castor.types.CRCReferenceType.fromValue("start");

    /**
     * Field _polynomial.
     */
    private org.hbird.transport.xtce.castor.Polynomial _polynomial;
    ...
    public CRC() {
        super();
        setReference(org.hbird.transport.xtce.castor.types.CRCReferenceType.fromValue("start"));
    }
     ...
     */
    public org.hbird.transport.xtce.castor.Polynomial getPolynomial(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.types.CRCReferenceType getReference(
    ) {
    ...
    public void setPolynomial(
            final org.hbird.transport.xtce.castor.Polynomial polynomial) {
    ...
    public void setReference(
            final org.hbird.transport.xtce.castor.types.CRCReferenceType reference) {
     ...
     */
    public static org.hbird.transport.xtce.castor.CRC unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.CRC) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.CRC.class, reader);
    }
