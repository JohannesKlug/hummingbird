...
public class Verifiers implements java.io.Serializable {
     ...
     */
    private org.hbird.transport.xtce.castor.TransferredToRangeVerifier _transferredToRangeVerifier;
     ...
     */
    private org.hbird.transport.xtce.castor.SentFromRangeVerifier _sentFromRangeVerifier;

    /**
     * A verifier that simply means the SpaceSystem has received
     * the command.
     */
    private org.hbird.transport.xtce.castor.ReceivedVerifier _receivedVerifier;

    /**
     * A verifier that means the SpaceSystem has accepted the comman
     */
    private org.hbird.transport.xtce.castor.AcceptedVerifier _acceptedVerifier;

    /**
     * A verifyer that means the command is scheduled for execution
     * by the SpaceSystem.
     */
    private org.hbird.transport.xtce.castor.QueuedVerifier _queuedVerifier;
     ...
     */
    private org.hbird.transport.xtce.castor.ExecutionVerifier _executionVerifier;

    /**
     * A possible set of verifiers that all must be true for the
     * command be considered completed. 
     */
    private java.util.List<org.hbird.transport.xtce.castor.CompleteVerifier> _completeVerifierList;

    /**
     * When true, indicates that the command failed. timeToWait is
     * how long to wait for the FailedVerifier to test true.
     */
    private org.hbird.transport.xtce.castor.FailedVerifier _failedVerifier;
    ...
    public Verifiers() {
        super();
        this._completeVerifierList = new java.util.ArrayList<org.hbird.transport.xtce.castor.CompleteVerifier>();
    }
    ...
    public void addCompleteVerifier(
            final org.hbird.transport.xtce.castor.CompleteVerifier vCompleteVerifier)
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.hbird.transport.xtce.castor.CompleteVerifier> enumerateCompleteVerifier(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.AcceptedVerifier getAcceptedVerifier(
    ) {
     ...
     * given index
     */
    public org.hbird.transport.xtce.castor.CompleteVerifier getCompleteVerifier(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.hbird.transport.xtce.castor.CompleteVerifier) _completeVerifierList.get(index);
    }
    ...
    public org.hbird.transport.xtce.castor.CompleteVerifier[] getCompleteVerifier(
        ...
        org.hbird.transport.xtce.castor.CompleteVerifier[] array = new org.hbird.transport.xtce.castor.CompleteVerifier[0];
        return (org.hbird.transport.xtce.castor.CompleteVerifier[]) this._completeVerifierList.toArray(array);
    }
     ...
     */
    public org.hbird.transport.xtce.castor.ExecutionVerifier getExecutionVerifier(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.FailedVerifier getFailedVerifier(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.QueuedVerifier getQueuedVerifier(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.ReceivedVerifier getReceivedVerifier(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.SentFromRangeVerifier getSentFromRangeVerifier(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.TransferredToRangeVerifier getTransferredToRangeVerifier(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends org.hbird.transport.xtce.castor.CompleteVerifier> iterateCompleteVerifier(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.CompleteVerifier removeCompleteVerifierAt(
            final int index) {
        java.lang.Object obj = this._completeVerifierList.remove(index);
        return (org.hbird.transport.xtce.castor.CompleteVerifier) obj;
    }
    ...
    public void setAcceptedVerifier(
            final org.hbird.transport.xtce.castor.AcceptedVerifier acceptedVerifier) {
     ...
     */
    public void setCompleteVerifier(
            final org.hbird.transport.xtce.castor.CompleteVerifier[] vCompleteVerifierArray) {
        //-- copy array
    ...
    public void setExecutionVerifier(
            final org.hbird.transport.xtce.castor.ExecutionVerifier executionVerifier) {
    ...
    public void setFailedVerifier(
            final org.hbird.transport.xtce.castor.FailedVerifier failedVerifier) {
    ...
    public void setQueuedVerifier(
            final org.hbird.transport.xtce.castor.QueuedVerifier queuedVerifier) {
    ...
    public void setReceivedVerifier(
            final org.hbird.transport.xtce.castor.ReceivedVerifier receivedVerifier) {
    ...
    public void setSentFromRangeVerifier(
            final org.hbird.transport.xtce.castor.SentFromRangeVerifier sentFromRangeVerifier) {
    ...
    public void setTransferredToRangeVerifier(
            final org.hbird.transport.xtce.castor.TransferredToRangeVerifier transferredToRangeVerifier) {
     ...
     */
    public static org.hbird.transport.xtce.castor.Verifiers unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.Verifiers) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.Verifiers.class, reader);
    }
