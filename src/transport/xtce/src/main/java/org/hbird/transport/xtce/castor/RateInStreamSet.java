...
public class RateInStreamSet implements java.io.Serializable {
     ...
     */
    private java.util.List<org.hbird.transport.xtce.castor.RateInStream> _rateInStreamList;
    ...
    public RateInStreamSet() {
        super();
        this._rateInStreamList = new java.util.ArrayList<org.hbird.transport.xtce.castor.RateInStream>();
    }
    ...
    public void addRateInStream(
            final org.hbird.transport.xtce.castor.RateInStream vRateInStream)
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.hbird.transport.xtce.castor.RateInStream> enumerateRateInStream(
    ) {
     ...
     * org.hbird.xtce.castor.RateInStream at the given
     * index
     */
    public org.hbird.transport.xtce.castor.RateInStream getRateInStream(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.hbird.transport.xtce.castor.RateInStream) _rateInStreamList.get(index);
    }
    ...
    public org.hbird.transport.xtce.castor.RateInStream[] getRateInStream(
        ...
        org.hbird.transport.xtce.castor.RateInStream[] array = new org.hbird.transport.xtce.castor.RateInStream[0];
        return (org.hbird.transport.xtce.castor.RateInStream[]) this._rateInStreamList.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends org.hbird.transport.xtce.castor.RateInStream> iterateRateInStream(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.RateInStream removeRateInStreamAt(
            final int index) {
        java.lang.Object obj = this._rateInStreamList.remove(index);
        return (org.hbird.transport.xtce.castor.RateInStream) obj;
    }
     ...
     */
    public void setRateInStream(
            final org.hbird.transport.xtce.castor.RateInStream[] vRateInStreamArray) {
        //-- copy array
     ...
     * org.hbird.xtce.castor.RateInStreamSet
     */
    public static org.hbird.transport.xtce.castor.RateInStreamSet unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.RateInStreamSet) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.RateInStreamSet.class, reader);
    }
