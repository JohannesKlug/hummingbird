...
public class AlarmRangesType implements java.io.Serializable {
     ...
     * Field _watchRange.
     */
    private org.hbird.transport.xtce.castor.WatchRange _watchRange;

    /**
     * Field _warningRange.
     */
    private org.hbird.transport.xtce.castor.WarningRange _warningRange;

    /**
     * Field _distressRange.
     */
    private org.hbird.transport.xtce.castor.DistressRange _distressRange;

    /**
     * Field _criticalRange.
     */
    private org.hbird.transport.xtce.castor.CriticalRange _criticalRange;

    /**
     * Field _severeRange.
     */
    private org.hbird.transport.xtce.castor.SevereRange _severeRange;
     ...
     */
    public org.hbird.transport.xtce.castor.CriticalRange getCriticalRange(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.DistressRange getDistressRange(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.SevereRange getSevereRange(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.WarningRange getWarningRange(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.WatchRange getWatchRange(
    ) {
    ...
    public void setCriticalRange(
            final org.hbird.transport.xtce.castor.CriticalRange criticalRange) {
    ...
    public void setDistressRange(
            final org.hbird.transport.xtce.castor.DistressRange distressRange) {
    ...
    public void setSevereRange(
            final org.hbird.transport.xtce.castor.SevereRange severeRange) {
    ...
    public void setWarningRange(
            final org.hbird.transport.xtce.castor.WarningRange warningRange) {
    ...
    public void setWatchRange(
            final org.hbird.transport.xtce.castor.WatchRange watchRange) {
     ...
     */
    public static org.hbird.transport.xtce.castor.AlarmRangesType unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.AlarmRangesType) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.AlarmRangesType.class, reader);
    }
