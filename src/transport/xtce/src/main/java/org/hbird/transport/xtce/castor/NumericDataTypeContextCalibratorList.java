...
public class NumericDataTypeContextCalibratorList implements java.io.Serializable {
     ...
     */
    private java.util.List<org.hbird.transport.xtce.castor.ContextCalibrator> _contextCalibratorList;
    ...
    public NumericDataTypeContextCalibratorList() {
        super();
        this._contextCalibratorList = new java.util.ArrayList<org.hbird.transport.xtce.castor.ContextCalibrator>();
    }
    ...
    public void addContextCalibrator(
            final org.hbird.transport.xtce.castor.ContextCalibrator vContextCalibrator)
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.hbird.transport.xtce.castor.ContextCalibrator> enumerateContextCalibrator(
    ) {
     ...
     * given index
     */
    public org.hbird.transport.xtce.castor.ContextCalibrator getContextCalibrator(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.hbird.transport.xtce.castor.ContextCalibrator) _contextCalibratorList.get(index);
    }
    ...
    public org.hbird.transport.xtce.castor.ContextCalibrator[] getContextCalibrator(
        ...
        org.hbird.transport.xtce.castor.ContextCalibrator[] array = new org.hbird.transport.xtce.castor.ContextCalibrator[0];
        return (org.hbird.transport.xtce.castor.ContextCalibrator[]) this._contextCalibratorList.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends org.hbird.transport.xtce.castor.ContextCalibrator> iterateContextCalibrator(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.ContextCalibrator removeContextCalibratorAt(
            final int index) {
        java.lang.Object obj = this._contextCalibratorList.remove(index);
        return (org.hbird.transport.xtce.castor.ContextCalibrator) obj;
    }
     ...
     */
    public void setContextCalibrator(
            final org.hbird.transport.xtce.castor.ContextCalibrator[] vContextCalibratorArray) {
        //-- copy array
     ...
     */
    public static org.hbird.transport.xtce.castor.NumericDataTypeContextCalibratorList unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.NumericDataTypeContextCalibratorList) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.NumericDataTypeContextCalibratorList.class, reader);
    }
