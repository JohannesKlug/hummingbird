...
public class SequenceEntryType implements java.io.Serializable {
     ...
     */
    private org.hbird.transport.xtce.castor.LocationInContainerInBits _locationInContainerInBits;

    /**
     * May be used when this entry repeats itself in the sequence
     * container. If not supplied, the entry does not repeat.
     */
    private org.hbird.transport.xtce.castor.RepeatEntry _repeatEntry;
     ...
     */
    private org.hbird.transport.xtce.castor.IncludeCondition _includeCondition;
     ...
     */
    public org.hbird.transport.xtce.castor.IncludeCondition getIncludeCondition(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.LocationInContainerInBits getLocationInContainerInBits(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.RepeatEntry getRepeatEntry(
    ) {
    ...
    public void setIncludeCondition(
            final org.hbird.transport.xtce.castor.IncludeCondition includeCondition) {
    ...
    public void setLocationInContainerInBits(
            final org.hbird.transport.xtce.castor.LocationInContainerInBits locationInContainerInBits) {
    ...
    public void setRepeatEntry(
            final org.hbird.transport.xtce.castor.RepeatEntry repeatEntry) {
     ...
     */
    public static org.hbird.transport.xtce.castor.SequenceEntryType unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.SequenceEntryType) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.SequenceEntryType.class, reader);
    }
