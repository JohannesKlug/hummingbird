...
public class ContextSignificanceList implements java.io.Serializable {
     ...
     */
    private java.util.List<org.hbird.transport.xtce.castor.ContextSignificance> _contextSignificanceList;
    ...
    public ContextSignificanceList() {
        super();
        this._contextSignificanceList = new java.util.ArrayList<org.hbird.transport.xtce.castor.ContextSignificance>();
    }
    ...
    public void addContextSignificance(
            final org.hbird.transport.xtce.castor.ContextSignificance vContextSignificance)
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.hbird.transport.xtce.castor.ContextSignificance> enumerateContextSignificance(
    ) {
     ...
     * the given index
     */
    public org.hbird.transport.xtce.castor.ContextSignificance getContextSignificance(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.hbird.transport.xtce.castor.ContextSignificance) _contextSignificanceList.get(index);
    }
    ...
    public org.hbird.transport.xtce.castor.ContextSignificance[] getContextSignificance(
        ...
        org.hbird.transport.xtce.castor.ContextSignificance[] array = new org.hbird.transport.xtce.castor.ContextSignificance[0];
        return (org.hbird.transport.xtce.castor.ContextSignificance[]) this._contextSignificanceList.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends org.hbird.transport.xtce.castor.ContextSignificance> iterateContextSignificance(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.ContextSignificance removeContextSignificanceAt(
            final int index) {
        java.lang.Object obj = this._contextSignificanceList.remove(index);
        return (org.hbird.transport.xtce.castor.ContextSignificance) obj;
    }
     ...
     */
    public void setContextSignificance(
            final org.hbird.transport.xtce.castor.ContextSignificance[] vContextSignificanceArray) {
        //-- copy array
     ...
     */
    public static org.hbird.transport.xtce.castor.ContextSignificanceList unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.ContextSignificanceList) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.ContextSignificanceList.class, reader);
    }
