...
public enum ParameterToSetTypeVerifierToTriggerOnType implements java.io.Serializable {
    ...
    private ParameterToSetTypeVerifierToTriggerOnType(final java.lang.String value) {
        this.value = value;
    }
     ...
     */
    public static org.hbird.transport.xtce.castor.types.ParameterToSetTypeVerifierToTriggerOnType fromValue(
