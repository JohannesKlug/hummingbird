...
public class ExternalAlgorithmSet implements java.io.Serializable {
     ...
     * implementation s
     */
    private java.util.List<org.hbird.transport.xtce.castor.ExternalAlgorithm> _externalAlgorithmList;
    ...
    public ExternalAlgorithmSet() {
        super();
        this._externalAlgorithmList = new java.util.ArrayList<org.hbird.transport.xtce.castor.ExternalAlgorithm>();
    }
    ...
    public void addExternalAlgorithm(
            final org.hbird.transport.xtce.castor.ExternalAlgorithm vExternalAlgorithm)
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.hbird.transport.xtce.castor.ExternalAlgorithm> enumerateExternalAlgorithm(
    ) {
     ...
     * given index
     */
    public org.hbird.transport.xtce.castor.ExternalAlgorithm getExternalAlgorithm(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.hbird.transport.xtce.castor.ExternalAlgorithm) _externalAlgorithmList.get(index);
    }
    ...
    public org.hbird.transport.xtce.castor.ExternalAlgorithm[] getExternalAlgorithm(
        ...
        org.hbird.transport.xtce.castor.ExternalAlgorithm[] array = new org.hbird.transport.xtce.castor.ExternalAlgorithm[0];
        return (org.hbird.transport.xtce.castor.ExternalAlgorithm[]) this._externalAlgorithmList.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends org.hbird.transport.xtce.castor.ExternalAlgorithm> iterateExternalAlgorithm(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.ExternalAlgorithm removeExternalAlgorithmAt(
            final int index) {
        java.lang.Object obj = this._externalAlgorithmList.remove(index);
        return (org.hbird.transport.xtce.castor.ExternalAlgorithm) obj;
    }
     ...
     */
    public void setExternalAlgorithm(
            final org.hbird.transport.xtce.castor.ExternalAlgorithm[] vExternalAlgorithmArray) {
        //-- copy array
     ...
     */
    public static org.hbird.transport.xtce.castor.ExternalAlgorithmSet unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.ExternalAlgorithmSet) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.ExternalAlgorithmSet.class, reader);
    }
