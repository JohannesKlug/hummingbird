...
public class NumericAlarmConditionType implements java.io.Serializable {
     ...
     */
    private org.hbird.transport.xtce.castor.NumericAlarmConditionTypeSequence _numericAlarmConditionTypeSequence;
     ...
     */
    private org.hbird.transport.xtce.castor.ConditionalAlarm _conditionalAlarm;

    /**
     * An escape for ridiculously complex alarm conditions. Will
     * trigger on changes to the containing Parameter. 
     */
    private org.hbird.transport.xtce.castor.CustomAlarm _customAlarm;
     ...
     */
    public org.hbird.transport.xtce.castor.ConditionalAlarm getConditionalAlarm(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.CustomAlarm getCustomAlarm(
    ) {
     ...
     * 'NumericAlarmConditionTypeSequence'.
     */
    public org.hbird.transport.xtce.castor.NumericAlarmConditionTypeSequence getNumericAlarmConditionTypeSequence(
    ) {
    ...
    public void setConditionalAlarm(
            final org.hbird.transport.xtce.castor.ConditionalAlarm conditionalAlarm) {
    ...
    public void setCustomAlarm(
            final org.hbird.transport.xtce.castor.CustomAlarm customAlarm) {
    ...
    public void setNumericAlarmConditionTypeSequence(
            final org.hbird.transport.xtce.castor.NumericAlarmConditionTypeSequence numericAlarmConditionTypeSequence) {
     ...
     */
    public static org.hbird.transport.xtce.castor.NumericAlarmConditionType unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.NumericAlarmConditionType) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.NumericAlarmConditionType.class, reader);
    }
