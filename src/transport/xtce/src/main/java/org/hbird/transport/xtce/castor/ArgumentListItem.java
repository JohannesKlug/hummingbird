...
public class ArgumentListItem implements java.io.Serializable {
     ...
     * Field _argumentList.
     */
    private java.util.List<org.hbird.transport.xtce.castor.Argument> _argumentList;
    ...
    public ArgumentListItem() {
        super();
        this._argumentList = new java.util.ArrayList<org.hbird.transport.xtce.castor.Argument>();
    }
    ...
    public void addArgument(
            final org.hbird.transport.xtce.castor.Argument vArgument)
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.hbird.transport.xtce.castor.Argument> enumerateArgument(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.Argument getArgument(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.hbird.transport.xtce.castor.Argument) _argumentList.get(index);
    }
    ...
    public org.hbird.transport.xtce.castor.Argument[] getArgument(
        ...
        org.hbird.transport.xtce.castor.Argument[] array = new org.hbird.transport.xtce.castor.Argument[0];
        return (org.hbird.transport.xtce.castor.Argument[]) this._argumentList.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends org.hbird.transport.xtce.castor.Argument> iterateArgument(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.Argument removeArgumentAt(
            final int index) {
        java.lang.Object obj = this._argumentList.remove(index);
        return (org.hbird.transport.xtce.castor.Argument) obj;
    }
     ...
     */
    public void setArgument(
            final org.hbird.transport.xtce.castor.Argument[] vArgumentArray) {
        //-- copy array
        _argumentList.clear();
