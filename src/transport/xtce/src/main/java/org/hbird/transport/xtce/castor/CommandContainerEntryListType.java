...
public class CommandContainerEntryListType implements java.io.Serializable {
     ...
     * Field _items.
     */
    private java.util.List<org.hbird.transport.xtce.castor.CommandContainerEntryListTypeItem> _items;
    ...
    public CommandContainerEntryListType() {
        super();
        this._items = new java.util.ArrayList<org.hbird.transport.xtce.castor.CommandContainerEntryListTypeItem>();
    }
    ...
    public void addCommandContainerEntryListTypeItem(
            final org.hbird.transport.xtce.castor.CommandContainerEntryListTypeItem vCommandContainerEntryListTypeItem)
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.hbird.transport.xtce.castor.CommandContainerEntryListTypeItem> enumerateCommandContainerEntryListTypeItem(
    ) {
     ...
     * org.hbird.xtce.castor.CommandContainerEntryListTypeItem
     * at the given index
     */
    public org.hbird.transport.xtce.castor.CommandContainerEntryListTypeItem getCommandContainerEntryListTypeItem(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.hbird.transport.xtce.castor.CommandContainerEntryListTypeItem) _items.get(index);
    }
    ...
    public org.hbird.transport.xtce.castor.CommandContainerEntryListTypeItem[] getCommandContainerEntryListTypeItem(
        ...
        org.hbird.transport.xtce.castor.CommandContainerEntryListTypeItem[] array = new org.hbird.transport.xtce.castor.CommandContainerEntryListTypeItem[0];
        return (org.hbird.transport.xtce.castor.CommandContainerEntryListTypeItem[]) this._items.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends org.hbird.transport.xtce.castor.CommandContainerEntryListTypeItem> iterateCommandContainerEntryListTypeItem(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.CommandContainerEntryListTypeItem removeCommandContainerEntryListTypeItemAt(
            final int index) {
        java.lang.Object obj = this._items.remove(index);
        return (org.hbird.transport.xtce.castor.CommandContainerEntryListTypeItem) obj;
    }
     ...
     */
    public void setCommandContainerEntryListTypeItem(
            final org.hbird.transport.xtce.castor.CommandContainerEntryListTypeItem[] vCommandContainerEntryListTypeItemArray) {
        //-- copy array
        _items.clear();
     ...
     * org.hbird.xtce.castor.CommandContainerEntryListType
     */
    public static org.hbird.transport.xtce.castor.CommandContainerEntryListType unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.CommandContainerEntryListType) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.CommandContainerEntryListType.class, reader);
    }
