...
public abstract class PCMStreamType extends org.hbird.transport.xtce.castor.NameDescriptionType 
implements java.io.Serializable
{
     ...
     * Field _pcmType.
     */
    private org.hbird.transport.xtce.castor.types.PCMStreamTypePcmTypeType _pcmType = org.hbird.transport.xtce.castor.types.PCMStreamTypePcmTypeType.fromValue("NRZL");
    ...
    public PCMStreamType() {
        super();
        setPcmType(org.hbird.transport.xtce.castor.types.PCMStreamTypePcmTypeType.fromValue("NRZL"));
    }
     ...
     */
    public org.hbird.transport.xtce.castor.types.PCMStreamTypePcmTypeType getPcmType(
    ) {
    ...
    public void setPcmType(
            final org.hbird.transport.xtce.castor.types.PCMStreamTypePcmTypeType pcmType) {
