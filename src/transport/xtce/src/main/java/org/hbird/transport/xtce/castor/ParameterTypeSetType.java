...
public class ParameterTypeSetType implements java.io.Serializable {
     ...
     * Field _items.
     */
    private java.util.List<org.hbird.transport.xtce.castor.ParameterTypeSetTypeItem> _items;
    ...
    public ParameterTypeSetType() {
        super();
        this._items = new java.util.ArrayList<org.hbird.transport.xtce.castor.ParameterTypeSetTypeItem>();
    }
    ...
    public void addParameterTypeSetTypeItem(
            final org.hbird.transport.xtce.castor.ParameterTypeSetTypeItem vParameterTypeSetTypeItem)
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.hbird.transport.xtce.castor.ParameterTypeSetTypeItem> enumerateParameterTypeSetTypeItem(
    ) {
     ...
     * at the given index
     */
    public org.hbird.transport.xtce.castor.ParameterTypeSetTypeItem getParameterTypeSetTypeItem(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.hbird.transport.xtce.castor.ParameterTypeSetTypeItem) _items.get(index);
    }
    ...
    public org.hbird.transport.xtce.castor.ParameterTypeSetTypeItem[] getParameterTypeSetTypeItem(
        ...
        org.hbird.transport.xtce.castor.ParameterTypeSetTypeItem[] array = new org.hbird.transport.xtce.castor.ParameterTypeSetTypeItem[0];
        return (org.hbird.transport.xtce.castor.ParameterTypeSetTypeItem[]) this._items.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends org.hbird.transport.xtce.castor.ParameterTypeSetTypeItem> iterateParameterTypeSetTypeItem(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.ParameterTypeSetTypeItem removeParameterTypeSetTypeItemAt(
            final int index) {
        java.lang.Object obj = this._items.remove(index);
        return (org.hbird.transport.xtce.castor.ParameterTypeSetTypeItem) obj;
    }
     ...
     */
    public void setParameterTypeSetTypeItem(
            final org.hbird.transport.xtce.castor.ParameterTypeSetTypeItem[] vParameterTypeSetTypeItemArray) {
        //-- copy array
        _items.clear();
     ...
     */
    public static org.hbird.transport.xtce.castor.ParameterTypeSetType unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.ParameterTypeSetType) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.ParameterTypeSetType.class, reader);
    }
