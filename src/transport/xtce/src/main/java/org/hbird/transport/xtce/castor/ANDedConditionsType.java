...
public class ANDedConditionsType implements java.io.Serializable {
     ...
     * Field _items.
     */
    private java.util.List<org.hbird.transport.xtce.castor.ANDedConditionsTypeItem> _items;
    ...
    public ANDedConditionsType() {
        super();
        this._items = new java.util.ArrayList<org.hbird.transport.xtce.castor.ANDedConditionsTypeItem>();
    }
    ...
    public void addANDedConditionsTypeItem(
            final org.hbird.transport.xtce.castor.ANDedConditionsTypeItem vANDedConditionsTypeItem)
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.hbird.transport.xtce.castor.ANDedConditionsTypeItem> enumerateANDedConditionsTypeItem(
    ) {
     ...
     * at the given index
     */
    public org.hbird.transport.xtce.castor.ANDedConditionsTypeItem getANDedConditionsTypeItem(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.hbird.transport.xtce.castor.ANDedConditionsTypeItem) _items.get(index);
    }
    ...
    public org.hbird.transport.xtce.castor.ANDedConditionsTypeItem[] getANDedConditionsTypeItem(
        ...
        org.hbird.transport.xtce.castor.ANDedConditionsTypeItem[] array = new org.hbird.transport.xtce.castor.ANDedConditionsTypeItem[0];
        return (org.hbird.transport.xtce.castor.ANDedConditionsTypeItem[]) this._items.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends org.hbird.transport.xtce.castor.ANDedConditionsTypeItem> iterateANDedConditionsTypeItem(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.ANDedConditionsTypeItem removeANDedConditionsTypeItemAt(
            final int index) {
        java.lang.Object obj = this._items.remove(index);
        return (org.hbird.transport.xtce.castor.ANDedConditionsTypeItem) obj;
    }
     ...
     */
    public void setANDedConditionsTypeItem(
            final org.hbird.transport.xtce.castor.ANDedConditionsTypeItem[] vANDedConditionsTypeItemArray) {
        //-- copy array
        _items.clear();
     ...
     */
    public static org.hbird.transport.xtce.castor.ANDedConditionsType unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.ANDedConditionsType) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.ANDedConditionsType.class, reader);
    }
