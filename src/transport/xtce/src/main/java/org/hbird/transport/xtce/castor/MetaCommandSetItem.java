...
public class MetaCommandSetItem implements java.io.Serializable {
     ...
     */
    private org.hbird.transport.xtce.castor.MetaCommand _metaCommand;
     ...
     * BlockMetaCommand.
     */
    private org.hbird.transport.xtce.castor.BlockMetaCommand _blockMetaCommand;
     ...
     */
    public org.hbird.transport.xtce.castor.BlockMetaCommand getBlockMetaCommand(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.MetaCommand getMetaCommand(
    ) {
    ...
    public void setBlockMetaCommand(
            final org.hbird.transport.xtce.castor.BlockMetaCommand blockMetaCommand) {
    ...
    public void setMetaCommand(
            final org.hbird.transport.xtce.castor.MetaCommand metaCommand) {
