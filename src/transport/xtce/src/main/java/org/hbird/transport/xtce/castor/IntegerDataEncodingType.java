...
public class IntegerDataEncodingType extends org.hbird.transport.xtce.castor.DataEncodingType 
implements java.io.Serializable
{
     ...
     * Field _encoding.
     */
    private org.hbird.transport.xtce.castor.types.IntegerDataEncodingTypeEncodingType _encoding = org.hbird.transport.xtce.castor.types.IntegerDataEncodingTypeEncodingType.fromValue("unsigned");
     ...
     * tests true
     */
    private org.hbird.transport.xtce.castor.IntegerDataEncodingTypeContextCalibratorList _contextCalibratorList;
    ...
    public IntegerDataEncodingType() {
        super();
        setEncoding(org.hbird.transport.xtce.castor.types.IntegerDataEncodingTypeEncodingType.fromValue("unsigned"));
    }
     ...
     */
    public org.hbird.transport.xtce.castor.IntegerDataEncodingTypeContextCalibratorList getContextCalibratorList(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.types.IntegerDataEncodingTypeEncodingType getEncoding(
    ) {
    ...
    public void setContextCalibratorList(
            final org.hbird.transport.xtce.castor.IntegerDataEncodingTypeContextCalibratorList contextCalibratorList) {
    ...
    public void setEncoding(
            final org.hbird.transport.xtce.castor.types.IntegerDataEncodingTypeEncodingType encoding) {
     ...
     */
    public static org.hbird.transport.xtce.castor.IntegerDataEncodingType unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.IntegerDataEncodingType) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.IntegerDataEncodingType.class, reader);
    }
