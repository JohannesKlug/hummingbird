...
public class StreamSetTypeItem implements java.io.Serializable {
     ...
     */
    private org.hbird.transport.xtce.castor.FixedFrameStream _fixedFrameStream;

    /**
     * Field _variableFrameStream.
     */
    private org.hbird.transport.xtce.castor.VariableFrameStream _variableFrameStream;

    /**
     * Field _customStream.
     */
    private org.hbird.transport.xtce.castor.CustomStream _customStream;
     ...
     */
    public org.hbird.transport.xtce.castor.CustomStream getCustomStream(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.FixedFrameStream getFixedFrameStream(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.VariableFrameStream getVariableFrameStream(
    ) {
    ...
    public void setCustomStream(
            final org.hbird.transport.xtce.castor.CustomStream customStream) {
    ...
    public void setFixedFrameStream(
            final org.hbird.transport.xtce.castor.FixedFrameStream fixedFrameStream) {
    ...
    public void setVariableFrameStream(
            final org.hbird.transport.xtce.castor.VariableFrameStream variableFrameStream) {
