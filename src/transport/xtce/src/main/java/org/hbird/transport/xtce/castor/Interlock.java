...
public class Interlock implements java.io.Serializable {
     ...
     */
    private org.hbird.transport.xtce.castor.types.InterlockVerificationToWaitForType _verificationToWaitFor = org.hbird.transport.xtce.castor.types.InterlockVerificationToWaitForType.fromValue("complete");
    ...
    public Interlock() {
        super();
        setVerificationToWaitFor(org.hbird.transport.xtce.castor.types.InterlockVerificationToWaitForType.fromValue("complete"));
    }
     ...
     */
    public org.hbird.transport.xtce.castor.types.InterlockVerificationToWaitForType getVerificationToWaitFor(
    ) {
    ...
    public void setVerificationToWaitFor(
            final org.hbird.transport.xtce.castor.types.InterlockVerificationToWaitForType verificationToWaitFor) {
     ...
     */
    public static org.hbird.transport.xtce.castor.Interlock unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.Interlock) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.Interlock.class, reader);
    }
