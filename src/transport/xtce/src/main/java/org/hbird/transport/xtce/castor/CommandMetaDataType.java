...
public class CommandMetaDataType implements java.io.Serializable {
     ...
     */
    private org.hbird.transport.xtce.castor.ParameterTypeSet _parameterTypeSet;
     ...
     */
    private org.hbird.transport.xtce.castor.ParameterSet _parameterSet;

    /**
     * Field _argumentTypeSet.
     */
    private org.hbird.transport.xtce.castor.ArgumentTypeSet _argumentTypeSet;

    /**
     * A set of Command Definitions
     */
    private org.hbird.transport.xtce.castor.MetaCommandSet _metaCommandSet;

    /**
     * The Command Container defines the construction of a Command.
     */
    private org.hbird.transport.xtce.castor.CommandContainerSet _commandContainerSet;

    /**
     * Field _streamSet.
     */
    private org.hbird.transport.xtce.castor.StreamSet _streamSet;

    /**
     * Field _algorithmSet.
     */
    private org.hbird.transport.xtce.castor.AlgorithmSet _algorithmSet;
     ...
     */
    public org.hbird.transport.xtce.castor.AlgorithmSet getAlgorithmSet(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.ArgumentTypeSet getArgumentTypeSet(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.CommandContainerSet getCommandContainerSet(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.MetaCommandSet getMetaCommandSet(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.ParameterSet getParameterSet(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.ParameterTypeSet getParameterTypeSet(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.StreamSet getStreamSet(
    ) {
    ...
    public void setAlgorithmSet(
            final org.hbird.transport.xtce.castor.AlgorithmSet algorithmSet) {
    ...
    public void setArgumentTypeSet(
            final org.hbird.transport.xtce.castor.ArgumentTypeSet argumentTypeSet) {
    ...
    public void setCommandContainerSet(
            final org.hbird.transport.xtce.castor.CommandContainerSet commandContainerSet) {
    ...
    public void setMetaCommandSet(
            final org.hbird.transport.xtce.castor.MetaCommandSet metaCommandSet) {
    ...
    public void setParameterSet(
            final org.hbird.transport.xtce.castor.ParameterSet parameterSet) {
    ...
    public void setParameterTypeSet(
            final org.hbird.transport.xtce.castor.ParameterTypeSet parameterTypeSet) {
    ...
    public void setStreamSet(
            final org.hbird.transport.xtce.castor.StreamSet streamSet) {
     ...
     */
    public static org.hbird.transport.xtce.castor.CommandMetaDataType unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.CommandMetaDataType) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.CommandMetaDataType.class, reader);
    }
