...
public class InputSetItem implements java.io.Serializable {
     ...
     */
    private org.hbird.transport.xtce.castor.InputAlgorithmTypeInputSetParameterInstanceRef _parameterInstanceRef;
     ...
     * constant to be used.
     */
    private org.hbird.transport.xtce.castor.Constant _constant;
     ...
     */
    public org.hbird.transport.xtce.castor.Constant getConstant(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.InputAlgorithmTypeInputSetParameterInstanceRef getParameterInstanceRef(
    ) {
    ...
    public void setConstant(
            final org.hbird.transport.xtce.castor.Constant constant) {
    ...
    public void setParameterInstanceRef(
            final org.hbird.transport.xtce.castor.InputAlgorithmTypeInputSetParameterInstanceRef parameterInstanceRef) {
