...
public class OutputSet implements java.io.Serializable {
     ...
     */
    private java.util.List<org.hbird.transport.xtce.castor.OutputParameterRef> _outputParameterRefList;
    ...
    public OutputSet() {
        super();
        this._outputParameterRefList = new java.util.ArrayList<org.hbird.transport.xtce.castor.OutputParameterRef>();
    }
    ...
    public void addOutputParameterRef(
            final org.hbird.transport.xtce.castor.OutputParameterRef vOutputParameterRef)
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.hbird.transport.xtce.castor.OutputParameterRef> enumerateOutputParameterRef(
    ) {
     ...
     * given index
     */
    public org.hbird.transport.xtce.castor.OutputParameterRef getOutputParameterRef(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.hbird.transport.xtce.castor.OutputParameterRef) _outputParameterRefList.get(index);
    }
    ...
    public org.hbird.transport.xtce.castor.OutputParameterRef[] getOutputParameterRef(
        ...
        org.hbird.transport.xtce.castor.OutputParameterRef[] array = new org.hbird.transport.xtce.castor.OutputParameterRef[0];
        return (org.hbird.transport.xtce.castor.OutputParameterRef[]) this._outputParameterRefList.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends org.hbird.transport.xtce.castor.OutputParameterRef> iterateOutputParameterRef(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.OutputParameterRef removeOutputParameterRefAt(
            final int index) {
        java.lang.Object obj = this._outputParameterRefList.remove(index);
        return (org.hbird.transport.xtce.castor.OutputParameterRef) obj;
    }
     ...
     */
    public void setOutputParameterRef(
            final org.hbird.transport.xtce.castor.OutputParameterRef[] vOutputParameterRefArray) {
        //-- copy array
     ...
     */
    public static org.hbird.transport.xtce.castor.OutputSet unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.OutputSet) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.OutputSet.class, reader);
    }
