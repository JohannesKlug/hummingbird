...
public class ComparisonCheckType implements java.io.Serializable {
     ...
     */
    private org.hbird.transport.xtce.castor.ParameterInstanceRef _parameterInstanceRef;

    /**
     * Field _comparisonOperator.
     */
    private org.hbird.transport.xtce.castor.types.ComparisonOperatorsType _comparisonOperator;

    /**
     * Field _comparisonCheckTypeChoice.
     */
    private org.hbird.transport.xtce.castor.ComparisonCheckTypeChoice _comparisonCheckTypeChoice;
     ...
     */
    public org.hbird.transport.xtce.castor.ComparisonCheckTypeChoice getComparisonCheckTypeChoice(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.types.ComparisonOperatorsType getComparisonOperator(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.ParameterInstanceRef getParameterInstanceRef(
    ) {
    ...
    public void setComparisonCheckTypeChoice(
            final org.hbird.transport.xtce.castor.ComparisonCheckTypeChoice comparisonCheckTypeChoice) {
    ...
    public void setComparisonOperator(
            final org.hbird.transport.xtce.castor.types.ComparisonOperatorsType comparisonOperator) {
    ...
    public void setParameterInstanceRef(
            final org.hbird.transport.xtce.castor.ParameterInstanceRef parameterInstanceRef) {
     ...
     */
    public static org.hbird.transport.xtce.castor.ComparisonCheckType unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.ComparisonCheckType) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.ComparisonCheckType.class, reader);
    }
