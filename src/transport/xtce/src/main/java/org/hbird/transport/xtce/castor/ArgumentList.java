...
public class ArgumentList implements java.io.Serializable {
     ...
     * Field _items.
     */
    private java.util.List<org.hbird.transport.xtce.castor.ArgumentListItem> _items;
    ...
    public ArgumentList() {
        super();
        this._items = new java.util.ArrayList<org.hbird.transport.xtce.castor.ArgumentListItem>();
    }
    ...
    public void addArgumentListItem(
            final org.hbird.transport.xtce.castor.ArgumentListItem vArgumentListItem)
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.hbird.transport.xtce.castor.ArgumentListItem> enumerateArgumentListItem(
    ) {
     ...
     * given index
     */
    public org.hbird.transport.xtce.castor.ArgumentListItem getArgumentListItem(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.hbird.transport.xtce.castor.ArgumentListItem) _items.get(index);
    }
    ...
    public org.hbird.transport.xtce.castor.ArgumentListItem[] getArgumentListItem(
        ...
        org.hbird.transport.xtce.castor.ArgumentListItem[] array = new org.hbird.transport.xtce.castor.ArgumentListItem[0];
        return (org.hbird.transport.xtce.castor.ArgumentListItem[]) this._items.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends org.hbird.transport.xtce.castor.ArgumentListItem> iterateArgumentListItem(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.ArgumentListItem removeArgumentListItemAt(
            final int index) {
        java.lang.Object obj = this._items.remove(index);
        return (org.hbird.transport.xtce.castor.ArgumentListItem) obj;
    }
     ...
     */
    public void setArgumentListItem(
            final org.hbird.transport.xtce.castor.ArgumentListItem[] vArgumentListItemArray) {
        //-- copy array
        _items.clear();
     ...
     */
    public static org.hbird.transport.xtce.castor.ArgumentList unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.ArgumentList) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.ArgumentList.class, reader);
    }
