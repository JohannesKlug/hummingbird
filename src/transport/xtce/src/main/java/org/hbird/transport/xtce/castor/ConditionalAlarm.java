...
public class ConditionalAlarm implements java.io.Serializable {
     ...
     */
    private org.hbird.transport.xtce.castor.StaticAlarmConditions _staticAlarmConditions;

    /**
     * Field _changePerSecondAlarmConditions.
     */
    private org.hbird.transport.xtce.castor.ChangePerSecondAlarmConditions _changePerSecondAlarmConditions;
     ...
     */
    public org.hbird.transport.xtce.castor.ChangePerSecondAlarmConditions getChangePerSecondAlarmConditions(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.StaticAlarmConditions getStaticAlarmConditions(
    ) {
    ...
    public void setChangePerSecondAlarmConditions(
            final org.hbird.transport.xtce.castor.ChangePerSecondAlarmConditions changePerSecondAlarmConditions) {
    ...
    public void setStaticAlarmConditions(
            final org.hbird.transport.xtce.castor.StaticAlarmConditions staticAlarmConditions) {
     ...
     */
    public static org.hbird.transport.xtce.castor.ConditionalAlarm unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.ConditionalAlarm) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.ConditionalAlarm.class, reader);
    }
