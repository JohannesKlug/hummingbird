...
public class BinaryDataEncodingType extends org.hbird.transport.xtce.castor.DataEncodingType 
implements java.io.Serializable
{
     ...
     * Field _sizeInBits.
     */
    private org.hbird.transport.xtce.castor.SizeInBits _sizeInBits;

    /**
     * Used to convert binary data to an application data type
     */
    private org.hbird.transport.xtce.castor.FromBinaryTransformAlgorithm _fromBinaryTransformAlgorithm;

    /**
     * Used to convert binary data from an application data type to
     * binary data
     */
    private org.hbird.transport.xtce.castor.ToBinaryTransformAlgorithm _toBinaryTransformAlgorithm;
     ...
     */
    public org.hbird.transport.xtce.castor.FromBinaryTransformAlgorithm getFromBinaryTransformAlgorithm(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.SizeInBits getSizeInBits(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.ToBinaryTransformAlgorithm getToBinaryTransformAlgorithm(
    ) {
    ...
    public void setFromBinaryTransformAlgorithm(
            final org.hbird.transport.xtce.castor.FromBinaryTransformAlgorithm fromBinaryTransformAlgorithm) {
    ...
    public void setSizeInBits(
            final org.hbird.transport.xtce.castor.SizeInBits sizeInBits) {
    ...
    public void setToBinaryTransformAlgorithm(
            final org.hbird.transport.xtce.castor.ToBinaryTransformAlgorithm toBinaryTransformAlgorithm) {
     ...
     */
    public static org.hbird.transport.xtce.castor.BinaryDataEncodingType unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.BinaryDataEncodingType) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.BinaryDataEncodingType.class, reader);
    }
