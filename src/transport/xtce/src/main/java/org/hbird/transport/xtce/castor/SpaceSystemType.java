...
public class SpaceSystemType extends org.hbird.transport.xtce.castor.NameDescriptionType 
implements java.io.Serializable
{
     ...
     * Field _header.
     */
    private org.hbird.transport.xtce.castor.Header _header;

    /**
     * Field _telemetryMetaData.
     */
    private org.hbird.transport.xtce.castor.TelemetryMetaData _telemetryMetaData;

    /**
     * Field _commandMetaData.
     */
    private org.hbird.transport.xtce.castor.CommandMetaData _commandMetaData;

    /**
     * A service is a logical grouping of container and/or messages.
     */
    private org.hbird.transport.xtce.castor.ServiceSet _serviceSet;
     ...
     */
    private org.hbird.transport.xtce.castor.Defaults _defaults;

    /**
     * The ROOT Element
     */
    private java.util.List<org.hbird.transport.xtce.castor.SpaceSystem> _spaceSystemList;
    ...
    public SpaceSystemType() {
        super();
        this._spaceSystemList = new java.util.ArrayList<org.hbird.transport.xtce.castor.SpaceSystem>();
    }
    ...
    public void addSpaceSystem(
            final org.hbird.transport.xtce.castor.SpaceSystem vSpaceSystem)
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.hbird.transport.xtce.castor.SpaceSystem> enumerateSpaceSystem(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.CommandMetaData getCommandMetaData(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.Defaults getDefaults(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.Header getHeader(
    ) {
        return this._header;
    }
     ...
     */
    public org.hbird.transport.xtce.castor.ServiceSet getServiceSet(
    ) {
     ...
     * index
     */
    public org.hbird.transport.xtce.castor.SpaceSystem getSpaceSystem(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.hbird.transport.xtce.castor.SpaceSystem) _spaceSystemList.get(index);
    }
    ...
    public org.hbird.transport.xtce.castor.SpaceSystem[] getSpaceSystem(
        ...
        org.hbird.transport.xtce.castor.SpaceSystem[] array = new org.hbird.transport.xtce.castor.SpaceSystem[0];
        return (org.hbird.transport.xtce.castor.SpaceSystem[]) this._spaceSystemList.toArray(array);
    }
     ...
     */
    public org.hbird.transport.xtce.castor.TelemetryMetaData getTelemetryMetaData(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends org.hbird.transport.xtce.castor.SpaceSystem> iterateSpaceSystem(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.SpaceSystem removeSpaceSystemAt(
            final int index) {
        java.lang.Object obj = this._spaceSystemList.remove(index);
        return (org.hbird.transport.xtce.castor.SpaceSystem) obj;
    }
    ...
    public void setCommandMetaData(
            final org.hbird.transport.xtce.castor.CommandMetaData commandMetaData) {
    ...
    public void setDefaults(
            final org.hbird.transport.xtce.castor.Defaults defaults) {
    ...
    public void setHeader(
            final org.hbird.transport.xtce.castor.Header header) {
        this._header = header;
    }
    ...
    public void setServiceSet(
            final org.hbird.transport.xtce.castor.ServiceSet serviceSet) {
     ...
     */
    public void setSpaceSystem(
            final org.hbird.transport.xtce.castor.SpaceSystem[] vSpaceSystemArray) {
        //-- copy array
    ...
    public void setTelemetryMetaData(
            final org.hbird.transport.xtce.castor.TelemetryMetaData telemetryMetaData) {
     ...
     */
    public static org.hbird.transport.xtce.castor.SpaceSystemType unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.SpaceSystemType) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.SpaceSystemType.class, reader);
    }
