...
public class MetaCommandType extends org.hbird.transport.xtce.castor.NameDescriptionType 
implements java.io.Serializable
{
     ...
     */
    private org.hbird.transport.xtce.castor.BaseMetaCommand _baseMetaCommand;
     ...
     * MetaCommand.
     */
    private org.hbird.transport.xtce.castor.ArgumentList _argumentList;

    /**
     * Tells how to package this command
     */
    private org.hbird.transport.xtce.castor.CommandContainer _commandContainer;

    /**
     * Appended to the TramsmissionConstraint List of the base
     * command. Constraints are checked in order. 
     */
    private org.hbird.transport.xtce.castor.TransmissionConstraintList _transmissionConstraintList;
     ...
     * MetaCommand.
     */
    private org.hbird.transport.xtce.castor.DefaultSignificance _defaultSignificance;

    /**
     * Used when the significance of a command varies by the
     * operating context
     */
    private org.hbird.transport.xtce.castor.ContextSignificanceList _contextSignificanceList;
     ...
     * SpaceSystem basis.
     */
    private org.hbird.transport.xtce.castor.Interlock _interlock;
     ...
     */
    private org.hbird.transport.xtce.castor.Verifiers _verifiers;

    /**
     * Parameters that are set with a new value after the command
     * has been sent. Appended to the Base Command list
     */
    private org.hbird.transport.xtce.castor.ParameterToSetList _parameterToSetList;
     ...
     */
    public org.hbird.transport.xtce.castor.ArgumentList getArgumentList(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.BaseMetaCommand getBaseMetaCommand(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.CommandContainer getCommandContainer(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.ContextSignificanceList getContextSignificanceList(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.DefaultSignificance getDefaultSignificance(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.Interlock getInterlock(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.ParameterToSetList getParameterToSetList(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.TransmissionConstraintList getTransmissionConstraintList(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.Verifiers getVerifiers(
    ) {
    ...
    public void setArgumentList(
            final org.hbird.transport.xtce.castor.ArgumentList argumentList) {
    ...
    public void setBaseMetaCommand(
            final org.hbird.transport.xtce.castor.BaseMetaCommand baseMetaCommand) {
    ...
    public void setCommandContainer(
            final org.hbird.transport.xtce.castor.CommandContainer commandContainer) {
    ...
    public void setContextSignificanceList(
            final org.hbird.transport.xtce.castor.ContextSignificanceList contextSignificanceList) {
    ...
    public void setDefaultSignificance(
            final org.hbird.transport.xtce.castor.DefaultSignificance defaultSignificance) {
    ...
    public void setInterlock(
            final org.hbird.transport.xtce.castor.Interlock interlock) {
    ...
    public void setParameterToSetList(
            final org.hbird.transport.xtce.castor.ParameterToSetList parameterToSetList) {
    ...
    public void setTransmissionConstraintList(
            final org.hbird.transport.xtce.castor.TransmissionConstraintList transmissionConstraintList) {
    ...
    public void setVerifiers(
            final org.hbird.transport.xtce.castor.Verifiers verifiers) {
     ...
     */
    public static org.hbird.transport.xtce.castor.MetaCommandType unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.MetaCommandType) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.MetaCommandType.class, reader);
    }
