 ...
 * SpaceSystem Tree (e.g., SimpleSat/Bus/EPDS/BatteryOne/Voltage).
 * To reference an individual member of an array use the zero based
 * bracket notation commonly used in languages like C, C++, and
 * Java.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class ParameterRefType implements java.io.Serializable {
    ...
    public ParameterRefType() {
        super();
        setContent("");
    }

    public ParameterRefType(final java.lang.String defaultValue) {
        try {
     ...
     */
    public static org.hbird.transport.xtce.castor.ParameterRefType unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.ParameterRefType) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.ParameterRefType.class, reader);
    }
