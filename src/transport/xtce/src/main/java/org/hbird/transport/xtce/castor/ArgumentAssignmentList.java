...
public class ArgumentAssignmentList implements java.io.Serializable {
     ...
     */
    private java.util.List<org.hbird.transport.xtce.castor.ArgumentAssignment> _argumentAssignmentList;
    ...
    public ArgumentAssignmentList() {
        super();
        this._argumentAssignmentList = new java.util.ArrayList<org.hbird.transport.xtce.castor.ArgumentAssignment>();
    }
    ...
    public void addArgumentAssignment(
            final org.hbird.transport.xtce.castor.ArgumentAssignment vArgumentAssignment)
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.hbird.transport.xtce.castor.ArgumentAssignment> enumerateArgumentAssignment(
    ) {
     ...
     * given index
     */
    public org.hbird.transport.xtce.castor.ArgumentAssignment getArgumentAssignment(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.hbird.transport.xtce.castor.ArgumentAssignment) _argumentAssignmentList.get(index);
    }
    ...
    public org.hbird.transport.xtce.castor.ArgumentAssignment[] getArgumentAssignment(
        ...
        org.hbird.transport.xtce.castor.ArgumentAssignment[] array = new org.hbird.transport.xtce.castor.ArgumentAssignment[0];
        return (org.hbird.transport.xtce.castor.ArgumentAssignment[]) this._argumentAssignmentList.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends org.hbird.transport.xtce.castor.ArgumentAssignment> iterateArgumentAssignment(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.ArgumentAssignment removeArgumentAssignmentAt(
            final int index) {
        java.lang.Object obj = this._argumentAssignmentList.remove(index);
        return (org.hbird.transport.xtce.castor.ArgumentAssignment) obj;
    }
     ...
     */
    public void setArgumentAssignment(
            final org.hbird.transport.xtce.castor.ArgumentAssignment[] vArgumentAssignmentArray) {
        //-- copy array
     ...
     */
    public static org.hbird.transport.xtce.castor.ArgumentAssignmentList unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.ArgumentAssignmentList) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.ArgumentAssignmentList.class, reader);
    }
