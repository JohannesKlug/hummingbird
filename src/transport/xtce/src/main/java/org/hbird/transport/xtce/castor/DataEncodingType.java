...
public class DataEncodingType implements java.io.Serializable {
     ...
     * Field _bitOrder.
     */
    private org.hbird.transport.xtce.castor.types.DataEncodingTypeBitOrderType _bitOrder = org.hbird.transport.xtce.castor.types.DataEncodingTypeBitOrderType.fromValue("mostSignificantBitFirst");

    /**
     * Field _errorDetectCorrect.
     */
    private org.hbird.transport.xtce.castor.ErrorDetectCorrect _errorDetectCorrect;
     ...
     */
    private org.hbird.transport.xtce.castor.ByteOrderList _byteOrderList;
    ...
    public DataEncodingType() {
        super();
        setBitOrder(org.hbird.transport.xtce.castor.types.DataEncodingTypeBitOrderType.fromValue("mostSignificantBitFirst"));
    }
     ...
     */
    public org.hbird.transport.xtce.castor.types.DataEncodingTypeBitOrderType getBitOrder(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.ByteOrderList getByteOrderList(
    ) {
     ...
     */
    public org.hbird.transport.xtce.castor.ErrorDetectCorrect getErrorDetectCorrect(
    ) {
    ...
    public void setBitOrder(
            final org.hbird.transport.xtce.castor.types.DataEncodingTypeBitOrderType bitOrder) {
    ...
    public void setByteOrderList(
            final org.hbird.transport.xtce.castor.ByteOrderList byteOrderList) {
    ...
    public void setErrorDetectCorrect(
            final org.hbird.transport.xtce.castor.ErrorDetectCorrect errorDetectCorrect) {
     ...
     */
    public static org.hbird.transport.xtce.castor.DataEncodingType unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.transport.xtce.castor.DataEncodingType) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.transport.xtce.castor.DataEncodingType.class, reader);
    }
