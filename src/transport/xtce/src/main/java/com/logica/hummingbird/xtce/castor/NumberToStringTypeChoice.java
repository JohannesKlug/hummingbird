...
public class NumberToStringTypeChoice implements java.io.Serializable {
     ...
     * Field _items.
     */
    private java.util.List<org.hbird.xtce.castor.NumberToStringTypeChoiceItem> _items;
    ...
    public NumberToStringTypeChoice() {
        super();
        this._items = new java.util.ArrayList<org.hbird.xtce.castor.NumberToStringTypeChoiceItem>();
    }
    ...
    public void addNumberToStringTypeChoiceItem(
            final org.hbird.xtce.castor.NumberToStringTypeChoiceItem vNumberToStringTypeChoiceItem)
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.hbird.xtce.castor.NumberToStringTypeChoiceItem> enumerateNumberToStringTypeChoiceItem(
    ) {
     ...
     * at the given index
     */
    public org.hbird.xtce.castor.NumberToStringTypeChoiceItem getNumberToStringTypeChoiceItem(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.hbird.xtce.castor.NumberToStringTypeChoiceItem) _items.get(index);
    }
    ...
    public org.hbird.xtce.castor.NumberToStringTypeChoiceItem[] getNumberToStringTypeChoiceItem(
        ...
        org.hbird.xtce.castor.NumberToStringTypeChoiceItem[] array = new org.hbird.xtce.castor.NumberToStringTypeChoiceItem[0];
        return (org.hbird.xtce.castor.NumberToStringTypeChoiceItem[]) this._items.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends org.hbird.xtce.castor.NumberToStringTypeChoiceItem> iterateNumberToStringTypeChoiceItem(
    ) {
     ...
     */
    public org.hbird.xtce.castor.NumberToStringTypeChoiceItem removeNumberToStringTypeChoiceItemAt(
            final int index) {
        java.lang.Object obj = this._items.remove(index);
        return (org.hbird.xtce.castor.NumberToStringTypeChoiceItem) obj;
    }
     ...
     */
    public void setNumberToStringTypeChoiceItem(
            final org.hbird.xtce.castor.NumberToStringTypeChoiceItem[] vNumberToStringTypeChoiceItemArray) {
        //-- copy array
        _items.clear();
     ...
     */
    public static org.hbird.xtce.castor.NumberToStringTypeChoice unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.hbird.xtce.castor.NumberToStringTypeChoice) org.exolab.castor.xml.Unmarshaller.unmarshal(org.hbird.xtce.castor.NumberToStringTypeChoice.class, reader);
    }
