...
public class TwosComplementLongCodecParameterTest {
	...
	private static final String TEST_LONG_STR_LE = "0101000100110100011101000110011001011010000000000000000000100000";
	private static BitSet TEST_LONG_BITSET_BE;
	private static BitSet TEST_LONG_BITSET_LE;
	...
	public static void setUpBeforeClass() throws Exception {
		...
		TEST_LONG_BITSET_LE = BitSetUtility.stringToBitSet(TEST_LONG_STR_LE, false, false);
		System.out.println(BitSetUtility.binDump(TEST_LONG_BITSET_LE));
	...
	public void setUp() throws Exception {
		Parameter<Long> parameterBigEndian = new HummingbirdParameter<Long>("", "", "", 64, Endianness.BIG, Encoding.twosComplement);
	...
	@Test
	public final void testEncodeLittleEndian() {
		Parameter<Long> parameter = new HummingbirdParameter<Long>("", "", "", 64, Endianness.LITTLE, Encoding.twosComplement);
		parameter.setValue(TEST_LONG);
		codec = new TwosComplementLongCodecParameter(parameter);

		BitSet actual = new BitSet();
		codec.encodeToBitSet(actual, 0);

		assertEquals("Expected encoded bitset to equal " + TEST_LONG_BITSET_LE, actual, TEST_LONG_BITSET_LE);
	}
