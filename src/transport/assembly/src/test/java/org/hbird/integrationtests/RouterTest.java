...
//	 .choice().
//	 when(header("Type").isEqualTo(MessageType.TMPacket)).
//	 to(packetEndpoint).
//	 when(header("Type").isEqualTo(MessageType.TMParameter)).
//	 to(parameterEndpoint);
//	 }
//	 };
//	 }
//	
...
//	 template.sendBody(getFrame());
//	
//	 assertIsInstanceOf(HummingbirdParameter.class,
//	 parameterEndpoint.getReceivedExchanges().get(0).getIn().getBody());
