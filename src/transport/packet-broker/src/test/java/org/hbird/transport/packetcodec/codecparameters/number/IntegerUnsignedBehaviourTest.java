...
public class IntegerUnsignedBehaviourTest {
	...
	public void testBigEndianBoundaryValueFromBitSet() throws InvalidParameterTypeException {
		LOG.info("###################### Beginning test #######################");
		UnsignedIntegerCodecParameter behaviour = new UnsignedIntegerCodecParameter(TEST_VALUE_LENGTH_1024, true);
	...
	public void testLittleEndianBoundaryValueFromBitSet() throws InvalidParameterTypeException {
		LOG.info("###################### Beginning test #######################");
		UnsignedIntegerCodecParameter behaviour = new UnsignedIntegerCodecParameter(TEST_VALUE_LENGTH_1024, false);
	...
	public void testZeroByteContainingValueFromBitSet() throws InvalidParameterTypeException {
		LOG.info("###################### Beginning test #######################");
		UnsignedIntegerCodecParameter behaviour = new UnsignedIntegerCodecParameter(TEST_VALUE_LENGTH_BE_123_32bit, true);
	...
	public final void testLeadingZeroBE999ValueFromBitSet() throws InvalidParameterTypeException {
		LOG.info("###################### Beginning test #######################");
		UnsignedIntegerCodecParameter behaviour = new UnsignedIntegerCodecParameter(TEST_VALUE_LENGTH_BE_999, true);
	...
	public void testInvalidSizeConstruction() throws InvalidParameterTypeException {
		LOG.info("###################### Beginning test #######################");
		new UnsignedIntegerCodecParameter(45, true);
	}

	@Test
	public void testGetName() throws InvalidParameterTypeException {
		LOG.info("###################### Beginning test #######################");
		assertEquals(new UnsignedIntegerCodecParameter(1, true).getTypeName(), 1 + TYPE_NAME);
	}
