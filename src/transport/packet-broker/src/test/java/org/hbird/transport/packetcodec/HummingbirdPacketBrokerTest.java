...
public class HummingbirdPacketBrokerTest {
	...
	// public static final String LASER_TEMP_17959_25 =
	...
	//
	// private SpaceSystemModelCodec packetBroker;
	//
	//
	// /**
	...
	// */
	// @Test
	// public final void testUnmarshallFlightDataPacket() throws UnknownParameterGroupException,
	// BitSetOperationException {
	...
	//
	// HummingbirdParameter packetPayloadLength = unmarshalledPacket
	// .getParameter(MockParameterContainerModel.PAYLOAD_LENGTH_PARAM_ALIAS);
	// assertEquals("Packet payload length should be " + PAYLOAD_PACKET_LENGTH, PAYLOAD_PACKET_LENGTH,
	// packetPayloadLength.getValue());
	//
	// HummingbirdParameter flightHourParam = unmarshalledPacket
	// .getParameter(MockParameterContainerModel.FLIGHT_HOURS_PARAM_ALIAS);
	...
	// packetPayloadLength.getValue());
	//
	// HummingbirdParameter laserTempParam = unmarshalledPacket
	// .getParameter(MockParameterContainerModel.LASER_TEMP_PARAM_ALIAS);
	...
	//
	// BitSet expected = BitSetUtility
	// .stringToBitSet(FLIGHT_DATA_APID + PACKET_LENGTH_32 + FLIGHT_HOURS_1024, false, false);
	//
	...
	//
	// @Test
	// public final void testMarshallBitSetLaserTempData() throws UnknownParameterGroupException,
	// BitSetOperationException {
	// LOG.info("---------- testMarshall -------------");
	//
	// // Populate the space system model that we will marshall into binary.
	...
	//
	// BitSet expected = BitSetUtility.stringToBitSet(LASER_DATA_APID + PACKET_LENGTH_64 + LASER_TEMP_17959_25, false,
	// false);
	//
	// BitSet marshalledPacket = new BitSet();
	// packetBroker.marshall(MockParameterContainerModel.TM_PACKET_ALIAS, marshalledPacket);
